...
# ---------- log ----------
log_path = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "logs", "Vgg4", "V1", "log_treino_df.txt"))
...
# ---------- df ----------
train_path_local = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "data", "df", "treino"))
val_path_local   = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "..", "data", "df", "validacao"))
